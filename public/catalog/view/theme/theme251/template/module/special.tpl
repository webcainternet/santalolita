			...
			<li class="<?php echo $a. $last_line ;?> span<?php echo $spanLine ;?>">
						...
						<div class="quick-view-<?php echo $i;?> preview">
							<div class="wrapper marg row-fluid">
								...
								<div class="right span8">
									...
									<div class="clear"></div>
									<div class="rating">
										<img height="18" src="catalog/view/theme/theme251/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
									</div>
								</div>
							</div>
				...
				<div class="inner">
					<div class="f-left">
						...
						<div class="name maxheight-spec"><a href="<?php echo $product['href']; ?>"><?php echo mb_substr($product['name'],0,20,'UTF-8').'...'; ?></a></div>
						<?php if ($product['description']) {?>
							<div class="description"><?php echo mb_substr($product['description1'],0,30,'UTF-8').'...';?></div>
						<?php } ?>
						<?php if ($product['price']) { ?>
						<div class="price">
							<?php if (!$product['special']) { ?>
