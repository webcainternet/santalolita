...
<div class="<?php if ($column_left or $column_right) { ?>span9<?php } ?> <?php if ($column_left and $column_right) { ?>span6<?php } ?> <?php if (!$column_right and !$column_left) { ?>span12 <?php } ?>" id="content"><?php echo $content_top; ?>
	...
	<div class="span6">
	  ...
	  <div class="cart">
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme251/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
					<a href="#tab-review"><?php echo $reviews; ?></a>
					<a href="#tab-review"><i class="icon-pencil"></i><?php echo $text_write; ?></a>
					<div class="clear"></div>
				</div>
			</div>
			<div class="clear"></div>
	...
	<div class="box-product"> 
		<ul class="related-slider">
			...
			<?php if ($product['rating']) { ?>
				<img height="13" src="catalog/view/theme/theme251/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
			<?php } ?>
			</div>
			</li>
			<?php } ?>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme251/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme251/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
